-- Full curriculum data export
DELETE FROM grammar_points;
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson01',1,'レッスン1：基本の自己紹介〜「叫」「姓」「是」を使って自分を紹介しよう！〜','1. 「叫」(jiào)
「叫」は「（名前は）〜と言います」という意味です。名前をフルネームや名前だけで紹介するときに使います。
...
2. 「姓」(xìng)
「姓」は「（苗字は）〜です」という意味です。苗字を伝えたいときに使います。
...
3. 「是」(shì)
「是」は「〜です」という意味です。職業や身分を説明するときに使います。
...
我 是 学生。','叫 → 名前を伝える
姓 → 苗字を伝える
是 → 身分や職業を伝える','https://www.youtube.com/watch?v=GN9R2v0DdPI');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson01',2,'形容詞を修飾する「很 / 不」','1. 形容詞を修飾する「很」
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=5SgA0Kgi7eE');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson01',3,'『嗎』を使った疑問文の作り方','「嗎」とは？
...
それではまた次回お会いしましょう～下次見！','https://www.youtube.com/watch?v=YIKdyV0ddZY');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson01',4,'中国語の省略型疑問文「呢」について','「呢（ne）」は、疑問や強調を表すための助詞で、特に次の2つの場面で使われます。
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=mdW6ulMOy1k');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson01',5,'喜歡で好きを伝えよう！','喜歡の文法解説
1. 基本構造
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=uKA37sRpNm0');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',1,'中国語文法の基本：動詞述語文','1. 時刻を聞く
例文:
...
金曜日: 星期五 (xīngqí wǔ)
土曜日: 星期六 (xīngqí liù)
日曜日: 星期天 (xīngqí tiān) または 星期日 (xīngqí rì)','練習問題
問題1: 次の日本語を中国語にしてください（ピンインも書いてください）。
今何時ですか？
今日は何曜日ですか？
今日は何日ですか？
問題2: 中国語の答えを書いてください。
...
今天星期幾？ (Jīntiān xīngqí jǐ?)
今天幾號？ (Jīntiān jǐ hào?)
解答2:
現在是三點。 (Xiànzài shì xiàwǔ sān diǎn.)
ヒント: 午前は「上午」、午後は「下午」と言います。
今天星期六。 (Jīntiān xīngqí liù.)
ヒント: 曜日は「星期」と数字の組み合わせで表します。
今天是十二月二十八號。 (Jīntiān shì shí''èr yuè èrshíbā hào.)
ヒント: 月は「月」、日付は「號」を使います。','今日学んだ内容は、時刻・日付・曜日の言い方と聞き方です。

時刻を聞く: 幾點？ (jǐ diǎn)
日付を聞く: 幾號？ (jǐ hào)
曜日を聞く: 星期幾？ (xīngqí jǐ)
これらをマスターすれば、日常会話でスムーズに時間や予定を話せるようになります！

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=ixi8CD3HnV4');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',2,'中国語の時間表現とその位置のルール','1. 基本ルール
時間表現は主語の後、動詞の前に置きます。
例：
日本語：私は昨日学校に行きました。
中国語：我昨天去學校了。
...
それではまた次回お会いしましょう～下次見！','https://www.youtube.com/watch?v=yPSGkONxp3E');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',3,'所有を表す中国語文法：有 yǒu と 沒有 méiyǒu','文法解説
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=k4EXo4On9Pw');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',4,'所有・所属を表す「的」について','1. 「的」の基本的な使い方はとてもシンプルで、
名詞 + 的 + 名詞
日本語の「AのB」に相当します。
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=Kr8fN2QFqOY');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',5,'助動詞「要」で意志や予定を伝えよう！','文法解説
1. 助動詞「要」とは？
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=5cjeFRPT1HA');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson02',6,'反復疑問文で会話をスムーズに！中国語の確認フレーズをマスターしよう','1. 反復疑問文とは？
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=sR1KUA2YPNE');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson03',1,'量詞と『幾』の使い方をマスターしよう！','文法解説
1. 量詞とは？
量詞（liàng cí）とは、名詞を数えるときに使う「単位」です。日本語の「本」「枚」「個」と同じです

【主な量詞の例】
量詞        説明        例文
個 (ge)        人や物など何にでも使える便利な量詞。    一個人    一個蘋果 (yī ge píngguǒ) → リンゴ1個
本 (běn)        本や雑誌など        一本書 (yī běn shū) → 本1冊
張 (zhāng)        紙や写真、机など平らなもの        一張紙 (yī zhāng zhǐ) → 紙1枚
支 (zhī)        ペンや棒状のもの        一支筆 (yī zhī bǐ) → ペン1本
杯（bēi）飲み物を数える際の単位。一杯茶 → 一杯のお茶（yì bēi chá）

2. 「幾」の使い方
「幾 (jǐ)」は「いくつ」「いくら」を表す疑問詞で、数を尋ねるときに使います。
後ろには量詞が必要です！
...
你有幾本書？
(Nǐ yǒu jǐ běn shū?) → 本は何冊ありますか？
這裡有幾個蘋果？
(Zhèli yǒu jǐ gè píngguǒ?) → ここにはリンゴがいくつありますか？

答えるとき→幾の部分を数字に変えるだけでOK！
你有幾本書？→我有「一本」書
這裡有幾個蘋果？→這裡有「三個」蘋果


3. 特別なポイント
数が「2」のときには「二（èr）」ではなく「兩（liǎng）」を使います。
例：兩個人（liǎng gè rén）

名詞によって使う量詞が異なるため、少しずつ覚えていきましょう。
リッキ‐のオススメ→適切な量詞が分からなければ、とりあえず個を使えば大丈夫です！
本もコップも個でオーケー！　大事なのは相手に伝わる事なので、全く問題ないです。','問題 1
以下の質問に答えてください：
...
你今天喝了幾杯水？
(Nǐ jīntiān hēle jǐ bēi shuǐ?)

ヒント
人には「個 (gè)」を使います。
本には「本 (běn)」を使います。
飲み物には「杯 (bēi)」を使います。','我家有三個人。
(Wǒ jiā yǒu sān gè rén.) → 私の家には3人います。
桌子上有五本書。
(Zhuōzi shàng yǒu wǔ běn shū.) → 机の上には5冊の本があります。
我今天喝了兩杯水。
(Wǒ jīntiān hēle liǎng bēi shuǐ.) → 今日、私は水を2杯飲みました。','今日のレッスンでは、以下を学びました：

中国語の「量詞」は、名詞の前に付けて数を表す。
答えるとき→幾の部分を数字に変えるだけでOK！
数が「2」のときには「二（èr）」ではなく「兩（liǎng）」を使います。
適切な量詞が分からなければ、とりあえず個を使えば大丈夫です！
量詞を使いこなせるようになると、中国語での会話がぐっと自然になりますよ！次回も一緒に中国語を楽しく学びましょう～下次見!','https://www.youtube.com/watch?v=oq1f7Gf9LvM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson03',2,'「送」を使った二重目的語構文の使い方','1. 二重目的語構文とは
...
他送弟弟一本書。
tā sòng dìdi yì běn shū','今日は「送」を使った二重目的語構文について学びました。「送」の使い方を覚えると、物を渡す場面でとても役に立ちます！たくさん練習して、ぜひ実際に使ってみてくださいね。それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=ImbYk204HJ4');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson03',3,'「これ」「それ」「どれ」の使い方をマスターしよう！ 這／那／哪＋数詞＋量詞＋名詞','1. 基本の形：這／那／哪＋数詞＋量詞＋名詞
...
数詞や量詞と組み合わせて使う
量詞の使い方を意識しよう
実生活でたくさん練習して、自然に使えるようにしましょう！それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=iYXDOANYRAk');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson03',4,'修飾語句としての「的」の使い方','文法解説
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=ZcwMy60-rl0');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson03',5,'「都（dōu）」を使ってみよう！どちらも、みんな、すべての表現をマスター！','文法解説
「主語 + 都 + 動詞/形容詞」
...
練習を繰り返して、ぜひ使いこなしてくださいね。それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=ksEZK0Po2SA');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson04',1,'目的語の置き換えで強調する中国語文法','文法解説
1. 通常の文型
目的語は通常、動詞の後ろに置かれます。 例：

我看了這本書。
Wǒ kàn le zhè běn shū.
私はこの本を読みました。
2. 強調のため目的語を文頭に置く
目的語を文頭に置くことで、何を強調しているのかをより明確にできます。この場合、「是」や「的」を使わず、直接目的語を前に置くだけです。
...
這件事我們解決了。
Zhè jiàn shì wǒmen jiějué le.
この件、私たちは解決しました。

他昨天的話我聽見了。
Tā zuótiān de huà wǒ tīngjiàn le.
彼の昨日の話、私は聞きました。','練習問題
問題1
以下の文を目的語を文頭に置いて書き換えてください。
...
ヒント
目的語を文頭に移動するだけです。
文法的な助詞（是や的）は使わないでください。','解答
蛋糕我吃了。
Dàngāo wǒ chī le.
ケーキ、私は食べました。

這個禮物他買了。
Zhè gè lǐwù tā mǎi le.
このプレゼント、彼が買いました。

這個計畫我們完成了。
Zhè gè jìhuà wǒmen wánchéng le.
この計画、私たちは完成しました。

他說的話我記住了。
Tā shuō de huà wǒ jìzhù le.
彼が言った言葉、私は覚えました。','まとめ
今日は「是」や「的」を使わずに、目的語を文頭に置いて強調する方法を学びました。
この文法は、シンプルで話しやすく、日常会話で頻繁に使われます。目的語を文頭に置くだけで、強調したい内容を簡単に伝えられる便利な表現です。ぜひ、日常の会話で試してみてください！

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=TovkBG0NErM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson04',2,'「也」の使い方～「～も」と表現する方法～','文法解説
1. 「也」の基本的な位置
「也」は通常、主語の後に置かれます。
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=oEJKwU_A7tE');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson04',3,'感情を強調！「太…了！」の使い方','文法解説
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=17KzrPyXXRI');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson04',4,'数の数え方を学ぼう！','文法解説
1. 基本の数字 (1から10)
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=mDeDdcVzqnY');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson04',5,'中国語で『～以上』を表す『多』をマスターしよう！','2. 「多」の位置とニュアンスの違い
(1) 数＋多＋量詞＋名詞
...
1. 基本の形
「主語 + 在 + 場所」
この形で「主語は〇〇（場所）にいる」という意味を表します。
例文
我在學校。
Wǒ zài xuéxiào. (Wǒ [3声], zài [4声], xuéxiào [2声,4声])
「私は学校にいます。」

他在家裡。
Tā zài jiālǐ. (Tā [1声], zài [4声], jiālǐ [1声,3声])
「彼は家にいます。」

老師在辦公室。
Lǎoshī zài bàngōngshì. (Lǎoshī [3声,1声], zài [4声], bàngōngshì [4声,1声,4声])
「先生はオフィスにいます。」

2. 疑問文の形
「主語 + 在哪裡？」または「主語 + 在哪兒？」
「どこにいますか？」と聞きたいときは「哪裡 (nǎlǐ)」または「哪兒 (nǎr)」を使います。
例文
你在哪裡？
Nǐ zài nǎlǐ? (Nǐ [3声], zài [4声], nǎlǐ [3声,3声])
「あなたはどこにいますか？」

你的書在哪兒？
Nǐ de shū zài nǎr? (Nǐ [3声], de [軽声], shū [1声], zài [4声], nǎr [3声])
「あなたの本はどこにありますか？」

3. 動作を表すとき
「在」の後ろに場所を置いて、さらに何をしているか動作を続けることもできます。
「主語 + 在 + 場所 + 動詞 + 目的語」
「主語は〇〇（場所）で△△（動作）をしている」という意味です。
例文
我在圖書館看書。
Wǒ zài túshūguǎn kànshū. (Wǒ [3声], zài [4声], túshūguǎn [2声,1声,3声], kànshū [4声,1声])
「私は図書館で本を読んでいます。」

他在家裡吃飯。
Tā zài jiālǐ chīfàn. (Tā [1声], zài [4声], jiālǐ [1声,3声], chīfàn [1声,4声])
「彼は家でご飯を食べています。」','問題1
次の文の（　）に入る、もっとも適切な言葉を選びましょう。
...
(B) 到
(C) 是
日本語の意味：「彼は家でお茶を飲んでいます。」

問題2：日本語の意味に合うように中文（繁體字）を完成してください。
「私は家でテレビを見ています。」


「あなたのお父さんはどこにいますか？」','解答例
你 在 哪裡？ (Nǐ zài nǎlǐ?)
我 在 圖書館看書。 (Wǒ zài túshūguǎn kànshū.)
他 在 家裡喝茶。 (Tā zài jiālǐ hēchá.)

2問目
Wǒ zài jiālǐ kàn diànshì.（我在家裡看電視。）
Nǐ de bàba zài nǎlǐ?（你的爸爸在哪裡？）','④ まとめ
今日は「在 (zài)」を使って「場所」を表す文の作り方を学びました。

「主語 + 在 + 場所」 で「主語が〇〇にいる」
「主語 + 在 + 場所 + 動詞」 で「主語が〇〇（場所）で△△している」
「疑問形」にするときは「在哪裡 (zài nǎlǐ)？」を使う
このポイントを押さえておくと、場所や行動をスムーズに伝えられるようになりますよ。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=RfqMaSL1kPw');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson05',2,'○○しようよ！提案をやわらかく伝える「吧（ba）」の使い方','文法解説：「吧（ba）」で提案を表す
1. 「吧（ba）」とは？
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=Jd0VdXKj2po');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson05',3,'方向詞を使って場所や動作を伝える文法「○○はどこで何をしている」','2．文法解説
（1）名詞＋在＋方向詞
形：
「名詞」＋「在（zài／ㄗㄞˋ）」＋「方向詞」
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=s56Sn0huSHM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson06',1,'「會(huì)」で「～できる」を言えるようになろう！','文法解説
1. 助動詞「會(huì)」の基本的な意味
「會(huì)」は「～できる」という能力や可能を表す助動詞です。
勉強し練習を積んでできるようになった技能を表す。

構造：主語 + 會(huì) + 動詞 + 目的語(あれば)
2. 例文
我會游泳。

pinyin: wǒ huì yóu yǒng (3-4-2-3)
意味: 私は泳ぐことができます。
他會做飯。

pinyin: tā huì zuò fàn (1-4-4-4)
意味: 彼は料理ができます。
你會說英文嗎？

pinyin: nǐ huì shuō yīng wén ma (3-4-1-1-2-0)
意味: あなたは英語を話せますか？
我不會開車。

pinyin: wǒ bú huì kāi chē (3-2-4-1-1)
意味: 私は車を運転できません。
3. 注意点
主語の後に「會(huì)」を置く：必ず動詞の前に入れましょう。
「會(huì)」には「(これから)～するつもりだ」という未来の意味もありますが、ここでは能力を表す用法に注目してください。','問題
私は自転車に乗ることができます。
彼女は歌を歌えます。
あなたは中華料理を作ることができますか？
先生はテニスができません。
私たちは漢字を書くことができます。','我會騎自行車。
wǒ huì qí zì xíng chē (3-4-2-4-2-1)
她會唱歌。
tā huì chàng gē (1-4-4-1)
你會做中國菜嗎？
nǐ huì zuò zhōng guó cài ma (3-4-4-1-2-4-0)
老師不會打網球。
lǎoshī bú huì dǎ wǎngqiú (3-1 2-4-3-3-2)
※「打網球(dǎ wǎngqiú)」で「テニスをする」という意味になります。','今回は「會(huì)」を使って「～できる」という表現を学びました。

構造：主語 + 會(huì) + 動詞(＋目的語)
「我會～」「你會～嗎？」の形で、いろいろな「できる・できない」を表現できます。
話したい動作に合わせて動詞を変えて活用してみましょう。
日常生活で「何ができるか」を伝えたいときに役立つ表現なので、ぜひ身につけてくださいね。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=xSy3MipRWKo');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson06',2,'構造助詞「得（de）」を使って動作の状態や結果を表そう！','文法解説
1. 
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=q-0_najlGmE');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson06',3,'ちょっと〇〇したいときに！「有(一)點(兒)」の使い方をマスターしよう','文法解説
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=a5KoJ7crgBw');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson06',4,'「～してもいい？」！「可以(kě yǐ)」」の使い方をマスターしよう','文法解説
1. 提案を表す「可以(kě yǐ)」
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=BMS__KZShf4');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson07',1,'○○から○○まで　從  と 到  を使った場所・方向表現の文法','文法解説
1. S + 從 (cóng2) / 到 (dào4) + 場所 + 來 (lái2) / 去 (qù4)
「從 (cóng2) + 場所 + 來 (lái2)」＝「（場所）から来る」
「到 (dào4) + 場所 + 去 (qù4)」＝「（場所）へ行く」
ここでは「S（主語）がどこから来るか」「S（主語）がどこへ行くか」を表すシンプルな文型です。

例文①（從を使った文：2つ）
我 (wǒ3) 從 (cóng2) 超市 (chāo1 shì4) 來 (lái2) 。
意味：私はスーパーから来ました。
弟弟 (dì4 di5) 從 (cóng2) 房間 (fáng2 jiān1) 來 (lái2) 。
意味：弟は部屋から来ます。
例文②（到を使った文：2つ）
你 (nǐ3) 到 (dào4) 公司 (gōng1 sī1) 去 (qù4) 嗎 (ma5)？
意味：あなたは会社へ行きますか？
媽媽 (mā1 ma5) 到 (dào4) 市場 (shì4 chǎng3) 去 (qù4) 。
意味：お母さんは市場へ行きます。
2. S + 從 (cóng2) + 場所1 + 到 (dào4) + 場所2 + 來/去 + 目的
「從 (cóng2) A 到 (dào4) B」＝「AからBまで」
後ろに「來 (lái2)／去 (qù4)」＋何をするか（目的）を付け加えると、「AからBまで行って～する」「AからBまで来て～する」という動作全体をまとめて言えます。
例文③（從～到～+ 來/去 + 目的：2つ）
我 (wǒ3) 從 (cóng2) 學校 (xué2 xiào4) 到 (dào4) 圖書館 (tú2 shū1 guǎn3) 去 (qù4) 看書 (kàn4 shū1) 。
意味：私は学校から図書館まで行って本を読みます。
哥哥 (gē1 ge5) 從 (cóng2) 家裡 (jiā1 lǐ5) 到 (dào4) 公園 (gōng1 yuán2) 來 (lái2) 跑步 (pǎo3 bù4) 。
意味：お兄さんは家から公園まで来てジョギングをします。','練習問題
下記の文を完成させてみましょう。文型を思い出しながら、(　) に入る適切な単語とピンインを考えてみてください。

問題①
我 ____ 飯館 ____ 。

ヒント：食事をしに「レストランへ行く」イメージで考えてみましょう。
問題②
他 ____ 教室 ____ 來 。

ヒント：「教室から来る」
問題③
我們 ____ 我家 ____ 車站 ____ 搭車 (dā1 chē1) 。

ヒント：家から駅までバスや電車などに乗りに行くイメージを作ってみましょう。「從 A 到 B 去 ○○する」か「來」かを選びましょう。','解答＆解説
問題① 解答
我 (wǒ3) 到 (dào4) 飯館 (fàn4 guǎn3) 去 (qù4) 。

「到 (dào4) + 場所 + 去 (qù4)」で「～へ行く」を表しています。
問題② 解答
他 (tā1) 從 (cóng2) 教室 (jiào4 shì4) 來 (lái2) 。

「從 (cóng2) + 場所 + 來 (lái2)」で「～から来る」を表します。
問題③ 解答
我們 (wǒ3 men5) 從 (cóng2) 我家 (wǒ3 jiā1) 到 (dào4) 車站 (chē1 zhàn4) 去 (qù4) 搭車 (dā1 chē1) 。

「從 (cóng2) A 到 (dào4) B + 去 (qù4) + 目的」で「AからBまで行って～する」という流れを表します。','まとめ
「從 (cóng2) + 場所 + 來 (lái2)」は「～から来る」。
「到 (dào4) + 場所 + 去 (qù4)」は「～へ行く」。
「從 (cóng2) A 到 (dào4) B + 來/去 + 目的」で「AからBまで（来て／行って）何をするか」を一文でまとめられる。
この文型を覚えると、「どこから来るか」「どこへ行くか」「どこからどこまで～しに行くか」が簡単に言えるようになります。ぜひ会話の中でたくさん使ってみてくださいね。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=oCDhUv9KqHs');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson07',2,'移動方法をマスターしよう！「どうやって行くの？」を中国語で言おう','1. 「どうやって」を表す「怎麼 zěn me(3 5)」
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=qvOELeroCCI');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson07',3,'「状況の変化を表す“了“」をマスターしよう！','文法解説
1．「S + 形容詞 + 了」で状態の変化を表す
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=t0gRXitTEOA');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson07',4,'「動詞＋目的語」を文の最初に置いて“感想“を言ってみよう！','文法解説
1. どんなときに使う？
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=j_zjSvRWV50');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson07',5,'「“又～又～”を使って、ひとつの主語に２つの特性を表そう！」','文法解説
1. 基本の形
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=uZM94h1wDgg');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson08',1,'「“好”と“難”を使った表現をマスターしよう！」','【文法解説】

1. 「好＋知覚動詞」／「難＋知覚動詞」
「好＋知覚動詞」は「～して良いと感じる」という意味になります。
「難＋知覚動詞」は「～して良くないと感じる」という意味になります。

知覚動詞とは
「好」「難」のあとは、**“吃(chī)・喝(hē)・聽(tīng)・看(kàn)”**などの感覚・知覚を表す動詞が入ります。
「好吃(おいしい)」「好聽(聞いて心地よい)」「難喝(おいしくない)」「難看(見ていてつまらない、または見苦しい)」など、いろいろな知覚動詞と組み合わせて覚えましょう。
使用例
這個水果很好吃。

Zhège shuǐguǒ hěn hǎo chī
（このフルーツはとてもおいしいと感じる）
這杯飲料難喝，別買了。

Zhè bēi yǐnliào nán hē, bié mǎi le
（この飲み物はおいしくないから、買うのやめよう）
你的聲音很好聽。
...
Zhè shǒu gē hěn nán tīng, wǒ tīng bú xià qù
（この歌は聞くのがつらい・聞きにくい）

2. 「好＋動作動詞」／「難＋動作動詞」
「好＋動作動詞」は「～しやすい」という意味です。
「難＋動作動詞」は「～しにくい」という意味です。
使用例
這件外套很好穿。

Zhè jiàn wàitào hěn hǎo chuān
（この上着は着やすい）
你的中文很好學嗎？

Nǐ de Zhōngwén hěn hǎo xué ma?
（あなたの中国語は学びやすいですか？／中国語は学びやすいですか？）
這道題太難寫了。

Zhè dào tí tài nán xiě le
（この問題は書きにくい・解きにくい）
你的名字很難念。

Nǐ de míngzì hěn nán niàn
（あなたの名前は発音しにくい）
ポイント

「好穿(hǎo chuān)」「好學(hǎo xué)」「難做(nán zuò)」「難念(nán niàn)」など、「好」「難」＋動作を表す動詞で「しやすさ・しにくさ」を表現します。
感覚的には「好＝〇〇しやすい」「難＝〇〇しにくい」と覚えるとわかりやすいです。','【練習問題】

問題A
次のカッコ内に「好」か「難」を入れて、正しい文にしましょう。

這個漢字很(　 )　　「書きやすい」の意味

Zhège Hànzì hěn (　 ) xiě
ヒント：とても書きやすい？書きにくい？
這道菜真　　，我要再點一份。　　「おいしい」の意味

Zhè dào cài zhēn (　 ) chī, wǒ yào zài diǎn yí fèn
ヒント：味が良くてたくさん食べたいときは？
這件衣服太小了，很（　　　　「着にくい」の意味

Zhè jiàn yīfu tài xiǎo le, hěn (　 ) chuān
ヒント：小さすぎる服は着やすい？着にくい？
這個字的發音真（　　　，我常常唸錯。

Zhège zì de fāyīn zhēn (　 ) niàn, wǒ chángcháng niàn cuò
ヒント：よく間違えるということは？','【解答例】
...
那首歌很難聽。
Nà shǒu gē hěn nán tīng','【まとめ】
今日は「好／難＋動詞」について学びました。

「好＋知覚動詞／難＋知覚動詞」で、「おいしい・おいしくない」「心地よい・聞きにくい」などの感覚を表せる。
「好＋動作動詞／難＋動作動詞」で、「しやすい・しにくい」という意味を表せる。
知覚動詞と動作動詞のどちらに「好」「難」を付けるのかを意識して使うのがポイント。
しっかり覚えておけば、会話の幅が広がりますよ。ぜひ例文を声に出して練習してみてくださいね。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=F8u1Uekqj5M');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson08',2,'「因為～所以」の使い方','1．文法解説
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=o3vgsuRkuwU');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson08',3,'「推測の『吧』」をマスターしよう！」','1．文法解説
◆「推測の『吧』」とは？
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=JFq8SvJHiO4');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson08',4,'VV看で『～してみる』！チャレンジ表現をマスターしよう','文法解説：「単音節動詞を2回＋看」で「～してみる」
1. 構造
単音節動詞を2回くり返し
そのあとに看(kàn) をつける
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=pqYh15zBiA8');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson08',5,'快（要）／要～了を使って、もうすぐ～するを言えるようになろう！「快（要）／要～了」でもうすぐ起こることを表現しよう！','文法解説
① 「快（要）～了」「要～了」：まもなく～する
...
それではまた次回お会いしましょう～ 下次見! 😊','https://www.youtube.com/watch?v=d1l90cxS6CI');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson09',1,'進行を表す「在」','進行を表す「在」の使い方
中国語では、動作が進行中であることを表すときに「在 (zài)」を使います。これは日本語の「～している」に相当します。

🔹 構造
主語 + 在 + 動詞 + 目的語

① 肯定文（～している）
動詞の前に「在 (zài)」を置くことで、現在進行中の動作を表します。

🔹 例文

我在吃飯。(Wǒ zài chī fàn.)
→ 私はご飯を食べています。
她在寫作業。(Tā zài xiě zuòyè.)
→ 彼女は宿題をしています。
他們在開會。(Tāmen zài kāihuì.)
→ 彼らは会議をしています。

② 否定文（～していない）
否定形は「沒 (méi)」または「沒有 (méiyǒu)」を「在」の前に置きます。
...
她沒有在寫作業。(Tā méiyǒu zài xiě zuòyè.)
→ 彼女は宿題をしていません。
他們沒在開會。(Tāmen méi zài kāihuì.)
→ 彼らは会議をしていません。


③ 疑問文（～していますか？）
疑問文は「在」を使った肯定文の後ろに「嗎 (ma)」をつけるだけです。または、「是不是 (shì bu shì)」を使って確認する形もあります。
...
你在吃飯嗎？(Nǐ zài chī fàn ma?)
→ あなたはご飯を食べていますか？
她在寫作業嗎？(Tā zài xiě zuòyè ma?)
→ 彼女は宿題をしていますか？
他們在開會嗎？(Tāmen zài kāihuì ma?)
→ 彼らは会議をしていますか？
🔹 構造②（是不是を使う）
主語 + 是不是 + 在 + 動詞 + 目的語？
...
你是不是在吃飯？(Nǐ shì bu shì zài chī fàn?)
→ あなたはご飯を食べているんですか？
她是不是在寫作業？(Tā shì bu shì zài xiě zuòyè?)
→ 彼女は宿題をしているんですか？
他們是不是在開會？(Tāmen shì bu shì zài kāihuì?)
→ 彼らは会議をしているんですか？','私は本を読んでいます。
...
你在做什麼？
(Nǐ zài zuò shénme?)','🎯 まとめ
✅ 進行形の「在」 は、日本語の「～している」に相当する。
✅ 肯定文では 「在 + 動詞」 を使う。
✅ 否定文では 「沒(有) + 在 + 動詞」 を使い、「不」は使わない。
✅ 疑問文は「嗎」をつけるか、「是不是」を使う。

これで「在」を使った進行形がバッチリ！🙆‍♂️
たくさん練習して自然に使えるようになりましょう！📖✨

それではまた次回お会いしましょう～ 下次見! 👋','https://www.youtube.com/watch?v=VFRRTP1zwDM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson09',2,'從…到…（時間）—— 中国語で期間を表す表現','文法解説
...
日常会話でどんどん使ってみてくださいね！
それではまた次回お会いしましょう～下次見! 🎉','https://www.youtube.com/watch?v=L-hihBzhl3A');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson09',3,'「先…再…」を使いこなそう！','🔹文法解説
...
それではまた次回お会いしましょう～ 下次見! 👋','https://www.youtube.com/watch?v=8hEC74TVgq8');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson09',4,'「能」の使い方：～できる・～してもいい','「能」は「能力があってできる」「状況的に可能である」という意味で使います。
...
それではまた次回お会いしましょう～下次见！','https://www.youtube.com/watch?v=tO2dgfUw3UM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson09',5,'「～のほうが比較的～だ」を言えるようになろう！','🔍 文法解説：「比較（bǐjiào）」の使い方
✅ 基本構造
👉 主語 ＋ 比較 ＋ 形容詞
意味：比較的○○だ
...
それではまた次回お会いしましょう～下次見! 👋','https://www.youtube.com/watch?v=Gca8RdPCRt4');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson10',1,'第10課『跟（gēn）』の使い方をマスターしよう！」','①「誰かと一緒に何かをする」意味の「～と」

日本語の「～と一緒に」にあたるイメージです。
例文1：我跟朋友一起去吃飯。（wǒ gēn péngyǒu yìqǐ qù chīfàn）
意味：私は友だちと一緒にご飯を食べに行きます。
例文2：我跟家人去旅行。（wǒ gēn jiārén qù lǚxíng）
意味：私は家族と旅行に行きます。
ポイント：
「一緒に」の感じを出したいときは「一起（yìqǐ）」をよくつけます。「我跟你一起～」で「私とあなたは一緒に～」という表現になります。

②「話したり、相談したり、会ったりする相手」を示す「～に／～と」

日本語で「〜に伝える」「〜と話す」のようなイメージです。
例文1：我跟老師說了這件事情。（wǒ gēn lǎoshī shuō le zhè jiàn shìqing）
意味：私は先生にこの件を伝えました。
例文2：我跟朋友討論了一下。（wǒ gēn péngyǒu tǎolùn le yíxià）
意味：私は友だちとちょっと相談しました。
例文3：我跟你見面吧。（wǒ gēn nǐ jiànmiàn ba）
意味：あなたと会いましょう。
ポイント：
「誰に話す」「誰に相談する」という表現をまとめて「跟」で表せるのが便利です。

③「物や情報をもらう（与えてくれる）相手」を示す「～から／～に向かって／～に対して」

日本語で「誰かから物をもらう」「誰かに（向かって）言われる」などにあたります。
例文1：我跟同事借了書。（wǒ gēn tóngshì jiè le shū）
意味：私は同僚から本を借りました。
例文2：我跟老師學到了很多知識。（wǒ gēn lǎoshī xuédào le hěn duō zhīshi）
意味：私は先生からたくさんの知識を学びました。
ポイント：
「誰から何かをもらう」「誰かに何かをしてもらう」ときも「跟」で表せます。実は「誰かを相手にする」という共通のイメージからくる使い方です。


【助動詞・副詞との語順】

次に、助動詞（例：想（xiǎng）・要（yào）など）や副詞（例：一起（yì qǐ）・常常（cháng cháng）など）が入る場合の語順を見てみましょう。
例：我想（xiǎng）跟同事去喝咖啡。（wǒ xiǎng gēn tóng shì qù hē kā fēi）
「私は同僚とコーヒーを飲みに行きたいです。」

例文3
我喜歡跟同事聊天。（wǒ xǐ huān gēn tóng shì liáo tiān）
「私は同僚とおしゃべりするのが好きです。」

我**常常（cháng cháng）跟朋友一起（yì qǐ）**看電影。（wǒ cháng cháng gēn péng yǒu yì qǐ kàn diàn yǐng）
「私は友達とよく一緒に映画を見ます。」','▼問題▼
...
「一緒に」のニュアンスがあるか？
「誰に話す」のニュアンスがあるか？
「誰から何かをもらう」のニュアンスがあるか？','▼解答例▼

我跟老師一起去開會。（wǒ gēn lǎoshī yìqǐ qù kāihuì）
你跟誰說了這個計畫？（nǐ gēn shéi shuō le zhège jìhuà）
我跟媽媽借了錢。（wǒ gēn māma jiè le qián）
我想跟你練習中文。（wǒ xiǎng gēn nǐ liànxí zhōngwén）','「跟（gēn）」は、とても使い勝手の良い言葉です。「誰かと一緒に～する」「誰かに話す・相談する」「誰かから何かをもらう」など、相手との関係をひとまとめにしてくれます。慣れないうちは「一緒に」「話す相手」「もらう相手」と意識しながら使ってみると、少しずつ自然に使えるようになりますよ。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=CutW3BPBF6k');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson10',2,'名詞を説明するときに使う『的』のカンタン使い方講座」','【文法解説】
...
────────────────────────────────── 【締めのあいさつ】
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=eZOb6HTtuSU');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson10',3,'「『多＋動詞』＆『少＋動詞』を使いこなそう！―『もっと～／～を控えよう』の中国語表現解説」','【文法解説】
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=40OxTASR6mg');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson10',4,'「“會(huì)”で未来の可能性を表す！中国語で「～だろう」を使いこなそう」','【文法解説】
...
「～するつもりだ」「～しようと思っている」「～する必要がある」というニュアンスが強いです。','https://www.youtube.com/watch?v=Gshaqjl0CZ8');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson10',5,'「要是／如果…就…」で条件を相手に伝えよう！','◆ 文法解説
基本の形
要是A…就B…
如果A…就B…
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=xM6_ZMJx5_E');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson11',1,'変化や完了を伝える『了』の使い方を徹底解説！','◆ 文法ポイント

まず「了」には大きく分けて２つの使い方があります。ひとつは文末に置いて「状態が変化した」ことを表す方法、もうひとつは動詞の後ろに置いて「動作が完了した」ことを表す方法です。

１．動詞の後ろに置いて「動作が完了した」ことを表す「了」
この使い方は、動作や出来事が完了したことを示します。
つまり、動詞の後に「了」を入れることで「〜した」という完了の意味になります。

例文（各例にピンインと声調付き）
我吃了飯。

我（wǒ）｜吃（chī）｜了（le）｜飯（fàn）
→ 「私はご飯を食べました。」
他寫了信。

他（tā）｜寫（xiě）｜了（le）｜信（xìn）
→ 「彼は手紙を書きました。」
我們看了電影。

我們（wǒmen）｜看（kàn）｜了（le）｜電影（diànyǐng）
→ 「私たちは映画を見ました。」


２．文末に置いて「状態が変化した」ことを表す「了」
こちらは文末に用いられ、状況の変化や新しい情報を伝えます。
動作の完了だけでなく、「今の状況が変わった」ことを強調するニュアンスがあります。

例文（各例にピンインと声調付き）
我到家了。

我（wǒ）｜到（dào）｜家（jiā）｜了（le）
→ 「私はすでに家に着きました。」
天黑了。
...
學校（xué xiào）｜放假（fàng jià）｜了（le）
→ 「学校は休みに入りました。」','問題１：
「私は宿題をした。」

ヒント：動作の完了を示すため、動詞「する」の後に「了」を入れましょう。
解答例：我做了功課。
ピンイン：我（wǒ）｜做（zuò）｜了（le）｜功課（gōng kè）

問題２：
「彼はコーヒーを飲んだ。」

ヒント：飲む動作が終わったことを表現します。
解答例：他喝了咖啡。
ピンイン：他（tā）｜喝（hē）｜了（le）｜咖啡（kā fēi）

問題３：
「雨が止んだ。」

ヒント：雨が止むという変化を表現しましょう。
解答例：雨停了。
ピンイン：雨（yǔ）｜停（tíng）｜了（le）

問題４：
「音楽が始まった。」

ヒント：音楽が始まったという新しい状態を伝えます。
解答例：音樂開始了。
ピンイン：音樂（yīn yuè）｜開始（kāi shǐ）｜了（le）','','◆ まとめ ◆

１．動詞の後ろに置いて「動作が完了した」ことを表す「了」
２．文末に置いて「状態が変化した」ことを表す「了」


「了」の使い方に慣れると、より自然な中国語で過去の経験や完了した出来事を伝えられるようになります。ぜひ会話で使ってみてください。

それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=5ssZYM5UWSU');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson11',2,'沒(méi) と 還沒(hái méi) 「まだ～していない」の言い方をマスタ‐しよう！','全ての文法解説
1. 「沒(méi)」の基本的な使い方
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=z0Rt4MTSMck');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson11',3,'「中国語の『是～的』構文で強調したい場所や時間をスッキリ表現！」','「是（shì）～的（de）」の基本イメージ
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=SwhinBljdSE');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson11',4,'「【中国語文法】先・等・再の使い方を徹底解説！」','◆ 文法解説
...
◆ 誰が + 用 + 何を使って + 何をする
まず、「誰が」という主語を置きます。
そのあとに「用（yòng）」を置き、「どの道具・手段・材料」を使うかを続けます。
最後に「何をする」の部分（動作や行動）を入れます。

1. 道具を使うときの「用」
例：我用手機打電話。（wǒ yòng shǒujī dǎ diànhuà）
→ 私は携帯電話で電話をかけます。
例：請用筷子吃飯。（qǐng yòng kuàizi chī fàn）
→ お箸を使ってご飯を食べてください。
2. 材料を使うときの「用」
例：她用麵粉做蛋糕。（tā yòng miànfěn zuò dàngāo）
→ 彼女は小麦粉を使ってケーキを作ります。

3. 方法・手段を表す「用」
例：請用中文說。（qǐng yòng zhōngwén shuō）
→ 中国語で話してください。
例：我們用微信聯絡。（wǒmen yòng wēixìn liánluò）
→ 私たちはWeChatで連絡を取ります。','練習問題
次の日本語を中国語に訳してみましょう！
パソコンを使って仕事をします。
ハサミで紙を切ります。
英語で自己紹介してください。
💡 ヒント：
「～を使って」は「用」を使います。
「話す」→「說（shuō）」、「書く」→「寫（xiě）」','解答例
我用電腦工作。（wǒ yòng diànnǎo gōngzuò）
我用剪刀剪紙。（wǒ yòng jiǎndāo jiǎn zhǐ）
請用英語自我介紹。（qǐng yòng yīngyǔ zìwǒ jièshào）','5. まとめ
「用」は「使う」「～を使って」「～で」という意味で、道具・材料・方法・手段を表すときに便利な言葉。
文の形としては「誰が＋用＋何を＋何をする」という順番が基本になる。
「用」を使うことで、行動するために使う道具や方法、材料が簡潔に分かりやすく表現できる。
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=kjOcLqrZtWc');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson12',2,'「“以前”と“以後”を使いこなそう！中国語で時間を伝える方法」','文法解説
1．「以前」「以後」の基本的なイメージ
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=jWFK6z4xWrQ');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson12',3,'「對（duì）」の使い方をマスターしよう','【文法解説】
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=AHfH0YNOHhY');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson12',4,'：「過」の使い方をマスターしよう！','①「動詞 + 過」：経験を表す
「過」は動詞の後ろにつけることで、
...
それではまた次回お会いしましょう～下次見! 👋','https://www.youtube.com/watch?v=yJnLWy-pB0E');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson12',5,'：「～の時」って中国語でどう言うの？「……的時候，……」の使い方を解説！','📖 「……的時候，……」の基本構造
...
この構造を使うと、「ちょっと〜してみる」や「軽く〜する」というニュアンスになります。
日本語でいうと「ちょっと見てみる」「少し食べてみる」といった感じですね！

🏆【V（一）V】の例文
① 試しにちょっと見てみる
📌 你看一看吧！（nǐ kàn yī kàn ba！）
👉 直訳：あなたはちょっと見てみて！
👉 「見てみてよ！」という軽いニュアンスで使えます。

③ ちょっと聞いてみる
📌 你問一問老師吧！（nǐ wèn yī wèn lǎoshī ba！）
👉 「先生にちょっと聞いてみたら？」

④ ちょっと試してみる
📌 你試一試這件衣服！（nǐ shì yī shì zhè jiàn yīfu！）
👉 「この服、ちょっと試してみて！」

✅【V（一）V】のポイント
📍 「一下」との違い
「一下（yīxià）」も似たような使い方ですが、以下のような違いがあります。

表現	ニュアンス
V（一）V	動作を軽く繰り返す感じ（少し長め）
V + 一下	動作を短く行うイメージ（より軽い）
例えば：
🔹 看一看（kàn yī kàn） → しっかりと少し見る
🔹 看一下（kàn yīxià） → さっと軽く見る

大きな意味の違いはないですが、「V（一）V」の方が少し長めに行うイメージ です！','✏️ 練習問題
次の日本語を中国語にしてみましょう！
ちょっと座ってください。
少し考えてみてください。
この本をちょっと読んでみてください。
...
「読む」＝看（kàn）
「話す」＝說（shuō）','📝 解答
請坐一坐。（qǐng zuò yī zuò.）
請想一想。（qǐng xiǎng yī xiǎng.）
請看一看這本書。（qǐng kàn yī kàn zhè běn shū.）
我們說一說吧！（wǒmen shuō yī shuō ba！）','🎯 まとめ
✅ 「V（一）V」は「ちょっと〜してみる」という軽いニュアンスを表す！
✅ 「一下」と似ているが、V（一）Vの方が少し長めの動作を表す！
✅ 日常会話でとてもよく使う便利な表現！

これで、今日の解説は終わりです！
それではまた次回お会いしましょう～ 下次見！ 👋','https://www.youtube.com/watch?v=R-r2886soXk');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson13',2,'從……往…… の使い方！','文法解説
🔹「從……往……」の基本構造
...
それではまた次回お会いしましょう～下次見！👋','https://www.youtube.com/watch?v=9mE9Ha6PE6s');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson13',3,'：「就」の使い方を完全マスター！簡単＆速い表現を学ぼう！','🔹 文法解説：「就（jiù）」の基本構造
「就」は 動詞の前 に置くことで、
...
それではまた次回お会いしましょう～ 下次見! 👋','https://www.youtube.com/watch?v=zhLwKjy2Ih0');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson13',4,'：「就要……了」でもうすぐ起こることを表現しよう！','🔹 文法解説：「就要……了」の基本構造
🔹「就要……了」＝ もうすぐ〇〇する
...
それではまた次回お会いしましょう～ 下次見! 👋','https://www.youtube.com/watch?v=OWKZ_rtrBvM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson13',5,'動作がどのくらい続く？持続時間を表す方法','🌟基本の形
...
それではまた次回お会いしましょう～下次見!','https://www.youtube.com/watch?v=e0sOpdhl6Pg');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson14',1,'「了」ってどう使う？時間の長さを伝える3パターン⏳【時間の継続①】','🧠文法解説：「了」で表す時間の継続（1つの動作）
🔸基本構造
主語 ＋ 動詞 ＋ 了 ＋ 時間

この形は、「その行動がすでに終わっていて、しかもどれくらいやってたかを伝える」時に使います。
...
✔️ ポイント：
「跑（pǎo）」＝走る、という動作に目的語がないので、シンプルにこの形でOKです。

✅ パターン②：目的語があるパターン①（動詞を繰り返す）
📌 主語 ＋ 動詞 ＋ 目的語 ＋ 動詞 ＋ 了 ＋ 時間，目的語を含む文も同様に動詞を繰り返す

👉 例文：
我做飯做了一個小時。
（wǒ zuòfàn zuò le yí ge xiǎoshí）
→ 私は料理を1時間しました。

✔️ ポイント：
「做飯（zuòfàn）」は目的語「飯」があるので、動詞＋目的語＋動詞＋了〜時間というふうに、動詞を繰り返します！
...
👉 例文：
他昨天看了三個小時的電視。
（tā zuótiān kàn le sān ge xiǎoshí de diànshì）
→ 彼は昨日3時間テレビを見ていました。

✔️ ポイント：
どのくらいの長さの目的語だったかを「時間＋的＋目的語」で表現します。
このパターンはよく出てくるので、しっかり覚えておきましょう！','📝 練習問題（3問）
次の日本語を中国語にしてみましょう！

Q1. 昨日、私は30分走りました。
ヒント：目的語なし

Q2. 母は昨日夕飯を2時間かけて作りました。
ヒント：動詞を繰り返すパターン

Q3. 私は週末に1時間の中国語レッスンを受けました。
ヒント：「時間＋的＋目的語」パターン','✅ 解答と解説
A1：
我昨天跑了三十分鐘。
（wǒ zuótiān pǎo le sānshí fēnzhōng）
👉 シンプルな動作に時間をつけたパターン！

A2：
媽媽昨天做飯做兩個小時。
（māma zuótiān zuòfàn zuò le liǎng ge xiǎoshí）
👉 動詞「做飯」が目的語を含むため、繰り返す！

A3：
我週末上了一個小時的中文課。
（wǒ zhōumò shàng le yí ge xiǎoshí de Zhōngwén kè）
👉 「中文課」が目的語なので「時間＋的＋目的語」に！','🎯 まとめ
✨ 今日は「了＋時間」で、どれくらいやったかを伝える3つの文の形を学びました！

🔹 目的語がない：そのまま「動詞＋了＋時間」
🔹 目的語がある（繰り返す）：動詞をもう一度使う
🔹 目的語がある（セットで言う）：時間＋的＋目的語

この文法が分かると、話せることの幅がぐんと広がりますよ😊

それではまた次回お会いしましょう～
下次見！👋','https://www.youtube.com/watch?v=_Vte0PL5aaY');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson14',2,'「了」が2回!? 今も続いている行動を伝える中国語表現⏱【時間の継続②】','🧠文法解説：「了」が2回使われるとき（今も続いている）
🔸基本構造
主語 ＋ 動詞 ＋ 了 ＋ 時間 ＋ 了
...
それではまた次回お会いしましょう～
下次見！👋','https://www.youtube.com/watch?v=2ldjZu3SZaw');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson14',3,'「比（bǐ）」の使い方完全マスター！“〜より◯◯”を中国語で言ってみよう！','🧠文法解説
🔹基本の文型
まずは基本のかたちから！
...
🧪 例文②（形容詞付き）
📘 他跟哥哥一樣高。
tā gēn gēge yíyàng gāo
→ 彼はお兄さんと同じくらい背が高いです。

📘 這家餐廳的菜跟那家不一樣辣。
zhè jiā cāntīng de cài gēn nà jiā bù yíyàng là
→ このレストランの料理はあの店ほど辛くない（同じように辛くはない）。

🧪 例文③（動作＋得）
📘 妹妹唱歌唱得跟姐姐一樣好聽。
mèimei chànggē chàng de gēn jiějie yíyàng hǎotīng
→ 妹はお姉さんと同じくらい歌がうまいです。

📘 他畫畫畫得跟老師不一樣精緻。
tā huàhuà huà de gēn lǎoshī bù yíyàng jīngzhì
→ 彼の絵は先生の絵ほど繊細ではありません。','🧩練習問題（各ヒント付き）
それでは、練習してみましょう！

Q1.
彼の性格は兄と同じです。
👉 ヒント：「性格」＝個性（gèxìng）／「彼」＝他
...
Q4.
私は中国語を、先生と同じくらい上手に話せます。
👉 ヒント：話す＝說（shuō）、上手＝好（hǎo）','✅解答・解説
A1.
他的個性跟哥哥一樣。
tā de gèxìng gēn gēge yíyàng
→ 「彼の性格は兄と同じです」

A2.
這部電影跟那部電影不一樣。
zhè bù diànyǐng gēn nà bù diànyǐng bù yíyàng
→ 「この映画とあの映画は違います」

A3.
她跟我一樣忙。
tā gēn wǒ yíyàng máng
→ 「彼女は私と同じくらい忙しいです」

A4.
我說中文說得跟老師一樣好。
wǒ shuō zhōngwén shuō de gēn lǎoshī yíyàng hǎo
→ 「私は中国語を、先生と同じくらい上手に話せます」','🧾まとめ
🎯 「……跟……一樣／不一樣」は、
✔ 名詞、形容詞、動詞の後にも使える
✔ 「～と～は同じ・違う」を自然に表現できる便利な文法！

それではまた次回お会いしましょう～
下次見！👋','https://www.youtube.com/watch?v=yBZYpQXLupc');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson15',2,'「一…就…」＝秒で◯◯！？反応の早さを表す魔法のフレーズ！','🧠文法解説｜一……就……の基本構造
🔸基本の形
👉　一（動作①），就（動作②）
...
それではまた次回お会いしましょう～下次見! 👋✨','https://www.youtube.com/watch?v=rCKvAmIuzgs');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book1-lesson15',3,'動作がず〜っと続いてる！「V着」の使い方をマスターしよう！✨','🧠文法解説：「V着」の基本構造
【基本構造】
👉　動詞 + 着（zhe）
...
✅例文②
📚圖書館離學校不太遠。
（tú shū guǎn lí xué xiào bú tài yuǎn）
→ 図書館は学校からそんなに遠くないです。
...
3️⃣ 新しい例文（文法解説用）📝
💬 我 想 一下 今晚 吃 什麼。
Wǒ xiǎng yí xià jīn wǎn chī shén me.
「今夜何を食べるかちょっと考えるね。」

💬 老師，你 能 幫 我 看 一下 作業 嗎？
Lǎo shī, nǐ néng bāng wǒ kàn yí xià zuò yè ma?
「先生、私の宿題をちょっと見てもらえますか？」

💬 小明 去 一下 隔壁 辦公室。
Xiǎo Míng qù yí xià gé bì bàn gōng shì.
「小明はちょっと隣のオフィスに行ってきます。」

💡 ポイント

“一下”を入れるだけで動作が軽く聞こえ、会話が自然に🎵

目的語がある場合は“一下”の後ろにつける','🏋️‍♀️ 練習問題
各文の（　　　）に入る最適な語を考えましょう。
ヒント：「動詞 + 一下」で“ちょっと〜する”を作ります。
...
📝 解説
どの文も“動詞 + 一下”で動作を軽く、短時間で行う雰囲気を出しています。お願いするときは語調も柔らかくなるので便利！','📝 まとめ
構造： 動詞 + 一下 (+ 目的語)

意味： 「ちょっと〜する」「さっと〜する」「試しに〜する」

効果： 動作時間の短さ＋ていねいな響き

応用： 看一下・等一下・問一下・想一下…など日常で大活躍❗️

“V 一下”を使いこなせば、中国語の会話がぐっと自然になりますよ😊','https://www.youtube.com/watch?v=2Qw-8_0SSSM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson01',2,'「“最好 + 動詞”で“～したほうがいい”を伝えよう！🌟」','📝 文法の基本構造
...
それではまた次回お会いしましょう～下次見! 👋','https://www.youtube.com/watch?v=6YXcIS7xeFQ');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson01',3,'「不但…也…」の使い方｜2つの良いことを伝える便利な表現！','🧠 文法解説｜基本の形と意味
「不但……，也……」の基本構造はこちら👇
...
いろんな場面で使えるので、ぜひ口に出して練習してみてくださいね！','https://www.youtube.com/watch?v=nmhhH68GgbM');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson01',4,'「動きが“全部終わった”ことを伝える『完』の使い方」','','','','','https://www.youtube.com/watch?v=sm4j7VNcxZw');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson01',5,'『「V在＋場所」で “どこにいるか・置くか” をスッキリ説明！','','','','','https://www.youtube.com/watch?v=POnN8uIVZq0');
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson01',6,'「動詞＋給」で“誰に何をする”が言える！','','','','','https://www.youtube.com/watch?v=VDKqshL5C5A');
...
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson05',4,'「V起來」の使い方完全マスター！始まりを伝える中国語表現','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson05',5,'中国語でギリギリセーフを表現！『還好～，要不然～』文法講座','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson05',6,'「毎週1回〇〇する」って中国語でどう言うの？“每～就～一回”の使い方徹底マスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson05',7,'「A像B一樣」ってどう使う？比べるときの中国語表現をマスターしよう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',1,'「言い間違えた！」って中国語で？動詞＋錯で失敗表現をマスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',2,' 「できるようになった！」を中国語で表す！動詞＋會の使い方徹底解説','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',3,' 「何でもOK！」の中国語表現〜想吃什麼就吃什麼〜の使い方！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',4,'「きっと〜するよ！」中国語で安心させる表現《會～的》の使い方','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',5,'「〜したらすぐ〜する」を中国語で言いたいときは？『等……就……』の使い方！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',6,'「たった〇〇しか…」中国語の「才」の使い方！主観的に“少ない”を伝える便利表現！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson06',7,'A讓B + 感情！中国語で「〜を〜な気持ちにさせる」言い方をマスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',1,'びっくり！「ひとつも〜ない」を強調する中国語表現【一＋M＋都／也＋不／沒】','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',2,'「〜させてあげる」「〜してもらう」の丁寧な言い方！中国語の『讓』の使い方','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',3,'「本当にきれいだね」はどう言う？中国語の強調「是＋形容詞」','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',4,'全部使い果たした！中国語の「V光了」使い方解説💡','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',5,'「全然～ない！」を強調する中国語文法：一點兒都不〜の使い方！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',6,'「〜したばかりで、すぐに〜」を中国語で！『剛...就...』の使い方をマスターしよう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson07',7,'「〜のうちに〇〇する！」中国語の「趁(著)」でチャンスを逃さず行動！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',1,'「～すら〇〇!?」驚きを伝える中国語表現！連～都の使い方をマスターしよう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',2,'「彼みたいな人」って中国語でどう言う？像〜這樣的Nをマスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',3,'選ぶ余地ナシ…「只好」で表す"やむを得ず"の気持ち【中国語文法】','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',4,'「〜のために」を中国語で言うと？「為了」の使い方完全ガイド！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',5,'接触・達成・心の変化を表す「上」の使い方をマスターしよう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson08',6,'「〜のせいで」を表す中国語：因為～的關係の使い方','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',1,'中国語ですぐ使える！「快一點兒」「慢一點兒」で急かす・ゆっくりしてと言える！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',2,'場所・時間・数量の到達を示す便利な表現「V+到」完全マスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',3,'疑問詞だけど疑問詞じゃない？「あまり〜ない」「特に〜してない」を表す【不/沒＋疑問詞】の使い方','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',4,'会話が一気にネイティブ風！驚きを表す「怎麼這麼…？」！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',5,'日本人が意外とできない中国語！V 得/不下「入りきる／入りきらない」をマスターしよう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson09',6,'リズムで覚える！中国語の動詞重ね型「乾乾淨淨的」「慢慢地走」完全マスター！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',1,'10課「不但…而且…」で中国語の文章を一気にレベルアップ！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',2,'これを言えたらネイティブ！強調表現「Vs死了」！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',3,'【ネイティブ必須】「越…越…」で「〜すればするほど」をスムーズに！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',4,'⭐︎日本語の「到底」とは違う？「いったい何なの？」を自然に言う方法！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',5,'【中国語の視点表現】「對NP來說」で「〜にとって」を自在に言おう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',6,'「的話」＝もし〜なら？一番簡単な仮定表現を完全解説！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson10',7,'【超便利表現】「對…有幫助」「有影響」「有好處」日常で使い倒そう！','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson11',1,'「分かる？分からない？“出來”の正体はこれ！」V 出來（V 出來了 / 沒 V 出來 / V 得出來 / V 不出來）','','','','',NULL);
...
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson13',4,'「あと少しで…！中国語で『もう少しで危なかった』を自然に言おう」 差(一)點','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson13',5,'「せっかく〜したのに…を表す！“白 + V”で悔しさをリアルに伝えよう」白 + V　','','','','',NULL);
...
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson15',4,'「まさかの展開に使える！『誰知道…？』で驚きや疑問を表現」','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson16',1,'「『場合による／〜次第』をスムーズに言える中国語フレーズ」得看 / 要看','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson16',2,'「具体例を挙げて説明！『〜みたいな／〜とか』を自然に言おう」像……什麼的','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson16',3,'「動作の繰り返しを表す！中国語で“〜しては〜する”を自在に」V來V去','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson16',4,'「比べたいときの決定版！『〜にかなわない／〜には敵わない』を自然に」比得/不上','','','','',NULL);
INSERT INTO grammar_points (lesson_id,sort_order,title,explanation,exercises,answers,summary,video_url) VALUES ('book2-lesson16',5,'「『〜してこそ…』の条件表現を中国語でマスター！」只有......才','','','','',NULL);
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson04',13,'家','jiā','家','[{"hanzi":"我家有五個人","pinyin":"Wǒ jiā yǒu wǔ gè rén.","translation_ja":"私の家族は5人です"},{"hanzi":"她今天不在家","pinyin":"Tā jīntiān bú zài jiā.","translation_ja":"彼女は今日は家にいません"},{"hanzi":"我們回家吧","pinyin":"Wǒmen huí jiā ba.","translation_ja":"家に帰りましょう"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson08',17,'瘦','shòu','痩せている','[{"hanzi":"她很瘦，穿什麼都好看","pinyin":"tā hěn shòu chuān shén me dōu hǎo kàn","translation_ja":"彼女は痩せていて何を着ても似合います"},{"hanzi":"你瘦了，是不是最近少吃了？","pinyin":"nǐ shòu le shì bú shì zuì jìn shǎo chī le","translation_ja":"痩せましたね、最近あまり食べていないのですか？"},{"hanzi":"我覺得這條褲子太瘦了，不舒服","pinyin":"wǒ jué de zhè tiáo kù zi tài shòu le bù shū fú","translation_ja":"このズボンは細すぎて居心地が悪いです"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson08',35,'黑','hēi','黒い','[{"hanzi":"這隻狗的毛很黑","pinyin":"zhè zhī gǒu de máo hěn hēi","translation_ja":"この犬の毛はとても黒いです"},{"hanzi":"天空很黑，看不到星星","pinyin":"tiān kōng hěn hēi kàn bú dào xīng xīng","translation_ja":"空が真っ暗で星が見えません"},{"hanzi":"他喜歡喝黑咖啡","pinyin":"tā xǐ huān hē hēi kā fēi","translation_ja":"彼はブラックコーヒーを飲むのが好きです"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson09',10,'在','zài','～にいる','[{"hanzi":"我在圖書館讀書","pinyin":"wǒ zài tú shū guǎn dú shū","translation_ja":"私は図書館で本を読んでいます"},{"hanzi":"他現在不在家","pinyin":"tā xiàn zài bú zài jiā","translation_ja":"彼は今、家にいません"},{"hanzi":"我們在公園見面吧","pinyin":"wǒ men zài gōng yuán jiàn miàn ba","translation_ja":"公園で会いましょう"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson09',28,'也許','yě xǔ','もしかしたら','[{"hanzi":"他也許今天不會來","pinyin":"tā yě xǔ jīn tiān bú huì lái","translation_ja":"彼はもしかしたら今日は来ないかもしれません"},{"hanzi":"也許明天會下雨","pinyin":"yě xǔ míng tiān huì xià yǔ","translation_ja":"明日は雨が降るかもしれません"},{"hanzi":"你也許應該休息一下","pinyin":"nǐ yě xǔ yīng gāi xiū xī yī xià","translation_ja":"あなたは少し休むべきかもしれません"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson11',21,'這樣','zhè yàng','このように','[{"hanzi":"這樣做比較快","pinyin":"zhè yàng zuò bǐ jiào kuài","translation_ja":"このようにやると早いです"},{"hanzi":"你這樣說不太好","pinyin":"nǐ zhè yàng shuō bú tài hǎo","translation_ja":"あなたの言い方はあまり良くありません"},{"hanzi":"他們這樣安排很合理","pinyin":"tā men zhè yàng ān pái hěn hé lǐ","translation_ja":"彼らのこのような手配は理にかなっています"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson11',26,'可能','kě néng','可能性がある','[{"hanzi":"他可能今天不會來","pinyin":"tā kě néng jīn tiān bú huì lái","translation_ja":"彼は今日来ないかもしれません"},{"hanzi":"明天可能會下雨","pinyin":"míng tiān kě néng huì xià yǔ","translation_ja":"明日は雨が降るかもしれません"},{"hanzi":"你有沒有可能參加這個活動","pinyin":"nǐ yǒu méi yǒu kě néng cān jiā zhè gè huó dòng","translation_ja":"あなたはこのイベントに参加できる可能性はありますか"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson12',19,'辛苦','xīn kǔ','大変、苦労する','[{"hanzi":"他每天工作很辛苦","pinyin":"tā měi tiān gōng zuò hěn xīn kǔ","translation_ja":"彼は毎日とても大変な仕事をしています"},{"hanzi":"學中文不容易，但也不太辛苦","pinyin":"xué zhōng wén bù róng yì, dàn yě bú tài xīn kǔ","translation_ja":"中国語を学ぶのは簡単ではありませんが、それほど大変でもありません"},{"hanzi":"辛苦了，休息一下吧","pinyin":"xīn kǔ le, xiū xí yī xià ba","translation_ja":"お疲れ様です、少し休んでください"}]');
...
INSERT INTO vocabulary (lesson_id,sort_order,hanzi,pinyin,translation_ja,examples_json) VALUES ('book1-lesson13',38,'方向','fāng xiàng','方向','[{"hanzi":"請問往車站的方向應該怎麼走？","pinyin":"qǐng wèn wǎng chē zhàn de fāng xiàng yīng gāi zěn me zǒu","translation_ja":"駅に向かう方向はどう行けばいいですか？"},{"hanzi":"我對這個方向不太熟，可能需要問一下別人","pinyin":"wǒ duì zhè ge fāng xiàng bú tài shú kě néng xū yào wèn yī xià bié rén","translation_ja":"この方向にはあまり詳しくないので、他の人に聞く必要がありそうです"},{"hanzi":"他朝著正確的方向走去了","pinyin":"tā cháo zhe zhèng què de fāng xiàng zǒu qù le","translation_ja":"彼は正しい方向に向かって歩いて行きました"}]');
